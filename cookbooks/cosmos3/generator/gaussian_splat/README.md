...
[`demos/cosmos3_gaussian_splat`](../../../../demos/cosmos3_gaussian_splat)
...
See the shared [Cosmos3 environment setup](../../README.md) for general backend requirements.
...
standalone [README](../../../../demos/cosmos3_gaussian_splat/README.md).
...
geometry-preserving object orbit is not demonstrated. A validated 60-step 360-degree request was
far outside the rotation distribution of NVIDIA's public example. Reducing the action to an
in-distribution 15-degree shallow turn preserved chair identity but still produced essentially no
parallax.

Treat command/VGGT disagreement as a quality gate. Do not run long Gaussian optimization when
generation has not produced genuine wide-baseline views. A reliable 360-degree asset workflow
requires a multiview-specific generator, geometry-guided render/inpainting, or a camera-control
model fine-tuned on near-field object-centric trajectories.
